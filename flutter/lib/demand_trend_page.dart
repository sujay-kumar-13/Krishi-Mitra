...
class DemandTrendPage extends StatefulWidget {
  ...
  const DemandTrendPage({super.key, required this.selectedState, required this.cropName, required this.language});
...
class _DemandTrendPageState extends State<DemandTrendPage> {
  ...
  Future<List<Map<String, dynamic>>> predictDemand(String state, String crop, DateTime startDate, DateTime endDate) async {
    final apiURL = 'https://krishi-mitra-1080111382250.asia-south1.run.app/predict_demand';
  ...
  Future<List<Map<String, dynamic>>> fetchPastDemand(String state, String crop, DateTime month) async {
    final apiUrl = 'https://krishi-mitra-1080111382250.asia-south1.run.app/pastDemand';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          "${getTranslatedValue(cropName!, language!) ?? cropName} ${getTranslatedValue("Demand Trend", language!) ?? 'Demand Trend'}",
          // "${cropName} Demand Trend",
              ...
              Container(
                ...
                child: _isLoading
                  ...
                  LineChartData(
                    ...
                    : Center(
                    child: Text(
                      getTranslatedValue("No Demand Data", language!) ?? "No demand data available to display.",
              ...
              LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  Widget pastPricesWidget = Column(
                    ...
                    children: [
                      Text(
                        "${getTranslatedValue('Past 6 Months Demand', language!) ?? "Past 6 months demand"}:",
                          ...
                          itemBuilder: (context, index) {
                            return Card(
                              ...
                              child: ListTile(
                                ...
                                trailing: Text(
                                  "${oCcy.format(pastPredictions[index]["demand"])} Q",
                  ...
                  Widget futurePricesWidget = Column(
                    ...
                    children: [
                      Text(
                        getTranslatedValue('Future Demand Predictions', language!) ?? "Future Demand Predictions:",
                        style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.brown),
                      ),
                      const SizedBox(height: 8),
                      ConstrainedBox(
